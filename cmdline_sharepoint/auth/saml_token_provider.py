...
from cmdline_sharepoint.auth.base_token_provider import BaseTokenProvider

cmdline_sharepoint.logger.ensure_debug_secrets()


class SamlTokenProvider(BaseTokenProvider, cmdline_sharepoint.logger.LoggerContext):
